...
- [x] Don't start from scratch or reuse your old solution because this is more simplified version! Sources are provided in the `src` folder of this directory.
...
- [x] Use v-on directive to increase the count data property everytime the main html area was clicked.
